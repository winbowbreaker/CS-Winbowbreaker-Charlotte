...
local VOICETABLE_WINBREAKER = {
    ...
    [CHAR_SOUND_YAHOO_WAHA_YIPPEE] = {'wahoo2.ogg', 'yippeeorsomethingg.ogg', 'charhooray.ogg'}, -- Triple jump sounds
    ...
    [CHAR_SOUND_YAHOO] = {'wahoo2.ogg', 'yippeeorsomethingg.ogg', 'charhooray.ogg'}, -- Long jump
    ...
    [CHAR_SOUND_TWIRL_BOUNCE] = {'yippeeorsomethingg.ogg', 'yippeeorsomethingg.ogg'}, -- Bouncing off of a flower spring
    ...
    [CHAR_SOUND_SO_LONGA_BOWSER] = 'bybeuy.ogg', -- Throwing Bowser
--DAMAGE

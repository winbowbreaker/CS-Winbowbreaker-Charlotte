...
local VOICETABLE_WINBREAKER = {
    ...
    [CHAR_SOUND_YAHOO] = {'wahoo2.ogg', 'yippeeorsomething.ogg', 'charhooray.ogg'}, -- Long jump
    ...
    [CHAR_SOUND_TWIRL_BOUNCE] = {'yippeeorsomething.ogg', 'yippeeorsomething.ogg'}, -- Bouncing off of a flower spring
